...
class ReportsController extends BaseController
{
    ...
    private function topagentrecruters()
    {
        // Load the database service
        $builder = \Config\Database::connect()->table('agent a');
        $builder->select('a.username, a.lastname, a.fistname, a.middlename, a.FA, a.rank, a.agentprofile, a.agent_token, (SELECT COUNT(*) FROM agent b WHERE b.FA = a.agent_id) AS total_fA');
        $builder->orderBy('total_fA', 'DESC');
